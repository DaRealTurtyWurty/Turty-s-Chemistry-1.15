...
public class ElectrolyzerScreen extends ContainerScreen<ElectrolyzerContainer> {
	...
	public void drawFluids() {
		...
		int waterHeight = (int) (57
				* (this.container.tileEntity.getStoredWater() / (float) this.container.tileEntity.getMaxWater()));
		int hydrogenHeight = (int) (57
				* (this.container.tileEntity.getStoredHydrogen() / (float) this.container.tileEntity.getMaxHydrogen()));
		int oxygenHeight = (int) (57
				* (this.container.tileEntity.getStoredOxygen() / (float) this.container.tileEntity.getMaxOxygen()));
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		this.renderTooltip(
				"Water: " + this.container.tileEntity.getStoredWater() + "/" + this.container.tileEntity.getMaxWater(),
				mouseX, mouseY, 8, 22, 12, 70);

		this.renderTooltip("Hydrogen: " + this.container.tileEntity.getStoredHydrogen() + "/"
				+ this.container.tileEntity.getMaxHydrogen(), mouseX, mouseY, 99, 113, 12, 70);

		this.renderTooltip("Oxygen: " + this.container.tileEntity.getStoredOxygen() + "/"
				+ this.container.tileEntity.getMaxOxygen(), mouseX, mouseY, 153, 167, 12, 70);
	}
}
