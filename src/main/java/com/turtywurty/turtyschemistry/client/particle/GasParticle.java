...
public class GasParticle extends SpriteTexturedParticle {
    ...
    private GasParticle(final ClientWorld worldIn, final double xSpeed, final double ySpeed,
            final double zSpeed) {
    ...
    public static class Factory implements IParticleFactory<BasicParticleType> {
        ...
        @Override
        public Particle makeParticle(final BasicParticleType typeIn, final ClientWorld worldIn,
                final double x, final double y, final double z, final double xSpeed, final double ySpeed,
                final double zSpeed) {
            final GasParticle underwaterparticle = new GasParticle(worldIn, x, y, z);
