...
public class HeliumGasPocket extends Feature<BlockStateFeatureConfig> {
	...
	@Override
	public boolean generate(final ISeedReader worldIn, final ChunkGenerator generator, final Random rand, BlockPos pos,
			final BlockStateFeatureConfig config) {
		...
		if (worldIn.getChunk(chunkpos.x, chunkpos.z, ChunkStatus.STRUCTURE_REFERENCES).getStructureReferences()
				.containsKey(Structure.VILLAGE))
			return false;
