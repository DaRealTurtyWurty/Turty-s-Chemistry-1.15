...
public final class StatsInit {
    ...
    public static final DeferredRegister<StatType<?>> STAT_TYPES = DeferredRegister
            .create(ForgeRegistries.STAT_TYPES, TurtyChemistry.MOD_ID);
    ...
    public static final ResourceLocation INTERACT_WITH_GAS_EXTRACTOR = registerCustom(
            "interact_with_gas_extractor");

    private StatsInit() {
    }

    private static ResourceLocation registerCustom(final String key) {
        final ResourceLocation resourcelocation = new ResourceLocation(TurtyChemistry.MOD_ID, key);
