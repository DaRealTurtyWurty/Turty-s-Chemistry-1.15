...
public final class ContainerTypeInit {
    ...
    public static final RegistryObject<ContainerType<FractionalDistillerContainer>> FRACTIONAL_DISTILLER = CONTAINER_TYPES
            .register("fractional_distiller",
                    () -> IForgeContainerType.create(FractionalDistillerContainer::new));
    ...
    public static final RegistryObject<ContainerType<AgitatorContainer>> AGITATOR = CONTAINER_TYPES
            .register("agitator", () -> new ContainerType<>(AgitatorContainer::getClientContainer));

    public static final RegistryObject<ContainerType<BalerContainer>> BALER = CONTAINER_TYPES
            .register("baler", () -> IForgeContainerType.create(BalerContainer::new));
    ...
    public static final RegistryObject<ContainerType<HopperContainer>> HOPPER = CONTAINER_TYPES
            .register("hopper", () -> IForgeContainerType.create(HopperContainer::new));
    ...
    public static final RegistryObject<ContainerType<BoilerContainer>> BOILER = CONTAINER_TYPES
            .register("boiler", () -> new ContainerType<>(BoilerContainer::getClientContainer));
