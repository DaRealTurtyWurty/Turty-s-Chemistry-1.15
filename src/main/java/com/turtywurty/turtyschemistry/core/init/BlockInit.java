...
public final class BlockInit {
    ...
    static final VoxelShape BRIQUETTING_TURNER_SHAPE = Stream
            .of(Block.makeCuboidShape(9.9, 9.5, 6.75, 10.1, 9.7, 8.75),
                    ...
                    Block.makeCuboidShape(9.5, 9, 8.5, 10.5, 10, 9.5),
                    Block.makeCuboidShape(9, 7, 8, 11, 8, 10))
    ...
    public static final RegistryObject<PropaneTankBlock> PROPANE_TANK = BLOCKS.register("propane",
            () -> new PropaneTankBlock(AbstractBlock.Properties.create(Material.IRON)
                    .hardnessAndResistance(0.6F).sound(SoundType.METAL).notSolid()));

    public static final RegistryObject<ButaneTankBlock> BUTANE_TANK = BLOCKS.register("butane",
            () -> new ButaneTankBlock(AbstractBlock.Properties.create(Material.IRON)
                    .hardnessAndResistance(0.6F).sound(SoundType.METAL).notSolid()));
    ...
    public static final RegistryObject<BriquettingPressBlock> BRIQUETTING_PRESS = BLOCKS.register(
            "briquetting_press", () -> new BriquettingPressBlock(makeMachineProperties().notSolid()));

    public static final RegistryObject<BriquettingPressPart> BRIQUETTING_TURNER = BLOCKS.register(
            "briquetting_turner",
    ...
    public static final RegistryObject<Block> BORAX = BLOCKS.register("borax", () -> new Block(
            AbstractBlock.Properties.from(Blocks.IRON_ORE).hardnessAndResistance(0.5f, 15.0f)));
    ...
    public static final RegistryObject<Block> ULEXITE = BLOCKS.register("ulexite",
            () -> new Block(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.WHITE_TERRACOTTA)
                    ...
                    .setLightLevel(state -> 5).sound(SoundType.GLASS).notSolid()));
    ...
    public static final RegistryObject<Block> KERNITE = BLOCKS.register("kernite",
            () -> new Block(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.STONE)
                    .harvestTool(ToolType.PICKAXE).harvestLevel(1).hardnessAndResistance(5.0f)
                    .setLightLevel(state -> 1).sound(SoundType.GLASS).notSolid()));
    ...
    public static final RegistryObject<GasCanisterBlock> GAS_CANISTER_S = BLOCKS.register(
            "gas_canister_small", () -> new GasCanisterBlock(makeMachineProperties().notSolid(), false));

    public static final RegistryObject<GasCanisterBlock> GAS_CANISTER_L = BLOCKS.register(
            "gas_canister_large", () -> new GasCanisterBlock(makeMachineProperties().notSolid(), true));
    ...
    public static final RegistryObject<Block> CADMIUM_BLOCK = BLOCKS.register("cadmium_block",
            () -> new Block(
                    AbstractBlock.Properties.from(Blocks.COBBLESTONE).hardnessAndResistance(1.0f, 4.5f)));
    ...
    public static final RegistryObject<Block> INDIUM_BLOCK = BLOCKS.register("indium_block", () -> new Block(
            AbstractBlock.Properties.from(Blocks.COBBLESTONE).hardnessAndResistance(0.5f, 2.5f)));
    ...
    public static final RegistryObject<AbstractSolarPanelBlock> BASIC_SOLAR_PANEL = BLOCKS.register(
            "basic_solar_panel", () -> new BasicSolarPanelBlock(makeMachineProperties().notSolid()));

    public static final RegistryObject<Block> RED_BERYL = BLOCKS.register("red_beryl", () -> new CrystalBlock(
            AbstractBlock.Properties.from(Blocks.DIORITE).notSolid().variableOpacity()));
    ...
    protected static AbstractBlock.Properties makeMachineProperties() {
        return AbstractBlock.Properties.create(Material.IRON).hardnessAndResistance(1.2f)
