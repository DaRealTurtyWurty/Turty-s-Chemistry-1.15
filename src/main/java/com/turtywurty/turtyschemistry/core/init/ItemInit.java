...
public final class ItemInit {
    ...
    public static final RegistryObject<Item> NIOBIUM = ITEMS.register("niobium",
            () -> new Item(makeItemProperties()));
    public static final RegistryObject<Item> MOLYDBENUM = ITEMS.register("molydbenum",
            () -> new Item(makeItemProperties()));
    ...
    public static final RegistryObject<Item> CURIUM = ITEMS.register("curium",
            () -> new Item(makeItemProperties()));
    public static final RegistryObject<Item> BERKELLIUM = ITEMS.register("berkellium",
            () -> new Item(makeItemProperties()));
    ...
    public static final RegistryObject<Item> MENDELEVIUM = ITEMS.register("mendelevium",
            () -> new Item(makeItemProperties()));
    public static final RegistryObject<Item> NOBELLIUM = ITEMS.register("nobellium",
            () -> new Item(makeItemProperties()));
    ...
    public static final RegistryObject<Item> DUBNIUM = ITEMS.register("dubnium",
            () -> new Item(makeItemProperties()));
    public static final RegistryObject<Item> SEABROGIUM = ITEMS.register("seabrogium",
            () -> new Item(makeItemProperties()));
    ...
    public static final RegistryObject<Item> NAPHTHA = ITEMS.register("naphtha",
            () -> new Item(makeItemProperties()));
    public static final RegistryObject<Item> KEROSINE = ITEMS.register("kerosine",
            () -> new Item(makeItemProperties()));
    ...
    public static final RegistryObject<Item> LUBRICATING_OIL = ITEMS.register("lubricating_oil",
            () -> new Item(makeItemProperties()));
    public static final RegistryObject<Item> FUEL_OIL = ITEMS.register("fuel_oil",
            () -> new Item(makeItemProperties()));
    ...
    public static final RegistryObject<Item> SAWDUST = ITEMS.register("sawdust",
            () -> new Item(makeItemProperties()));
    public static final RegistryObject<Item> BRIQUETTE = ITEMS.register("briquette",
            () -> new Item(makeItemProperties()));
    ...
    public static final RegistryObject<Item> WIRE_GAUZE = ITEMS.register("wire_gauze",
            () -> new Item(makeItemProperties()));
