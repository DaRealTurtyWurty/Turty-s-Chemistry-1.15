...
public final class TileEntityTypeInit {
    ...
    public static final RegistryObject<TileEntityType<FractionalDistillerTileEntity>> FRACTIONAL_DISTILLER = TILE_ENTITY_TYPES
            .register("fractional_distiller",
                    () -> TileEntityType.Builder
                            .create(FractionalDistillerTileEntity::new, BlockInit.FRACTIONAL_DISTILLER.get())
                            .build(null));

    public static final RegistryObject<TileEntityType<AgitatorTileEntity>> AGITATOR = TILE_ENTITY_TYPES
            .register("agitator", () -> TileEntityType.Builder
                    .create(AgitatorTileEntity::new, BlockInit.AGITATOR.get()).build(null));

    public static final RegistryObject<TileEntityType<AutoclaveTileEntity>> AUTOCLAVE = TILE_ENTITY_TYPES
            .register("autoclave", () -> TileEntityType.Builder
                    .create(AutoclaveTileEntity::new, BlockInit.AUTOCLAVE.get()).build(null));
    ...
    public static final RegistryObject<TileEntityType<BalerTileEntity>> BALER = TILE_ENTITY_TYPES.register(
            "baler",
    ...
    public static final RegistryObject<TileEntityType<GasifierTileEntity>> GASIFIER = TILE_ENTITY_TYPES
            .register("gasifier", () -> TileEntityType.Builder
                    .create(GasifierTileEntity::new, BlockInit.GASIFIER.get()).build(null));

    public static final RegistryObject<TileEntityType<SiloTileEntity>> SILO = TILE_ENTITY_TYPES.register(
            "silo",
            () -> TileEntityType.Builder.create(SiloTileEntity::new, BlockInit.SILO.get()).build(null));

    public static final RegistryObject<TileEntityType<HopperTileEntity>> HOPPER = TILE_ENTITY_TYPES.register(
            "hopper",
            () -> TileEntityType.Builder.create(HopperTileEntity::new, BlockInit.HOPPER.get()).build(null));

    public static final RegistryObject<TileEntityType<CableTileEntity>> CABLE = TILE_ENTITY_TYPES.register(
            "cable",
    ...
    public static final RegistryObject<TileEntityType<ResearcherTileEntity>> RESEARCHER = TILE_ENTITY_TYPES
            .register("researcher", () -> TileEntityType.Builder
                    .create(ResearcherTileEntity::new, BlockInit.RESEARCHER.get()).build(null));
