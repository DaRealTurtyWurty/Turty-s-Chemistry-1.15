...
public class GreenAlgaeBlock extends BushBlock {
    ...
    protected static final VoxelShape GREEB_ALGAE_SHAPE = Block.makeCuboidShape(1.0D, 0.0D, 1.0D, 15.0D, 1.5D,
            15.0D);
    ...
    public boolean isValidPosition(final BlockState state, final IWorldReader worldIn, final BlockPos pos) {
        final FluidState fluidstate = worldIn.getFluidState(pos.down());
