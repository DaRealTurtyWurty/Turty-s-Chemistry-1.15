...
public class BalerTileEntity extends LockableLootTileEntity
    ...
    private final String[] recipes = { "minecraft:string", "minecraft:string", WHEAT, WHEAT, WHEAT, WHEAT,
    ...
    public boolean isValidRecipe(final String[] recipesIn, final List<ItemStack> itemsIn) {
        ...
        for (final ItemStack stack : itemsIn) {
    ...
    public void tick() {
        ...
        if (this.completed && this.itemTicksExisted < 200) {
            ...
            final Direction facing = getBlockState().get(BaseHorizontalBlock.HORIZONTAL_FACING);
