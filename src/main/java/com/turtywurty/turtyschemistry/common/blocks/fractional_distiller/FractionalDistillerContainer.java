...
public class FractionalDistillerContainer extends Container {
    ...
    public FractionalDistillerContainer(final int windowId, final PlayerInventory playerInventory,
        ...
        trackInt(new FunctionalIntReferenceHolder(() -> tileEntity.processTimeLeft,
                v -> tileEntity.processTimeLeft = (short) v));
        trackInt(new FunctionalIntReferenceHolder(() -> tileEntity.maxProcessingTime,
                v -> tileEntity.maxProcessingTime = (short) v));

        // Slots
        addSlot(new SlotItemHandler(tileEntity.inventory, FractionalDistillerTileEntity.CRUDE_SLOT, 49, 73));
        addSlot(new SlotItemHandler(tileEntity.inventory, FractionalDistillerTileEntity.BITUMEN_SLOT, 195,
                150));
        addSlot(new SlotItemHandler(tileEntity.inventory, FractionalDistillerTileEntity.FUELOIL_SLOT, 174,
                138));
        addSlot(new SlotItemHandler(tileEntity.inventory, FractionalDistillerTileEntity.LUBOIL_SLOT, 174,
                116));
        addSlot(new SlotItemHandler(tileEntity.inventory, FractionalDistillerTileEntity.KEROSINE_SLOT, 174,
                88));
        addSlot(new SlotItemHandler(tileEntity.inventory, FractionalDistillerTileEntity.NAPHTHA_SLOT, 174,
                60));
        addSlot(new SlotItemHandler(tileEntity.inventory, FractionalDistillerTileEntity.PETROL_SLOT, 174,
                32));
        addSlot(new SlotItemHandler(tileEntity.inventory, FractionalDistillerTileEntity.REFGAS_SLOT, 195, 4));
    ...
    public boolean canInteractWith(@Nonnull final PlayerEntity player) {
        return isWithinUsableDistance(this.canInteractWithCallable, player,
                BlockInit.FRACTIONAL_DISTILLER.get());
    }
