...
public class FractionalDistillerTileEntity extends TileEntity
            ...
            if (canInsertResultIntoOutput) {
                ...
                if (this.processTimeLeft == -1) {
                    ...
                    if (this.processTimeLeft == 0) {
                        this.inventory.insertItem(REFGAS_SLOT, new ItemStack(ItemInit.REFINARY_GAS.get()),
                                false);
                        ...
                        this.inventory.insertItem(KEROSINE_SLOT, new ItemStack(ItemInit.KEROSINE.get()),
                                false);
                        this.inventory.insertItem(DIESEL_SLOT, new ItemStack(ItemInit.DIESEL.get()), false);
                        this.inventory.insertItem(LUBOIL_SLOT, new ItemStack(ItemInit.LUBRICATING_OIL.get()),
                                false);
                        this.inventory.insertItem(FUELOIL_SLOT, new ItemStack(ItemInit.FUEL_OIL.get()),
                                false);
