...
public class ResearcherScreen extends ContainerScreen<ResearcherContainer> {
	...
	public static class BlueprintScrollPanel extends ScrollPanel {
		...
		public BlueprintScrollPanel(final Minecraft client, final ResearcherScreen screen,
				final List<IRecipe<CraftingInventory>> recipes, final int width, final int height, final int top,
				final int left) {
			...
			if (world != null) {
				for (IRecipe<CraftingInventory> recipe : recipes /*
																	 * ResearcherRecipe.getAllBlueprints(world.
																	 * getRecipeManager())
																	 */) {
	...
	public void init() {
		...
		List<IRecipe<CraftingInventory>> recipes = world != null ? null // ResearcherRecipe.getBlueprints(world.getRecipeManager())
				: ImmutableList.of();
