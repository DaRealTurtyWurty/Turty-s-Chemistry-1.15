...
public class FractionalDistillerScreen extends ContainerScreen<FractionalDistillerContainer> {
	...
	public FractionalDistillerScreen(final FractionalDistillerContainer screenContainer, final PlayerInventory inv,
	...
	protected void drawGuiContainerForegroundLayer(final MatrixStack stack, final int mouseX, final int mouseY) {
		...
		if (tileEntity.processTimeLeft > 0) {
			this.font.drawString(stack, tileEntity.processTimeLeft + " / " + tileEntity.maxProcessingTime, 8.0f, 1.0f,
					0x404040);
		}
	}
