...
import com.turtywurty.turtyschemistry.core.util.SiloPart;
...
public class SiloBlock extends Block {
	...
	protected static final Map<Direction, VoxelShape> BOTTOM_SHAPES = new HashMap<Direction, VoxelShape>();
	protected static final Map<Direction, VoxelShape> MIDDLE_SHAPES = new HashMap<Direction, VoxelShape>();
	protected static final Map<Direction, VoxelShape> TOP_SHAPES = new HashMap<Direction, VoxelShape>();
	...
	public float getBlockHardness(BlockState blockState, IBlockReader worldIn, BlockPos pos) {
		return blockState.get(PARTS).equals(SiloPart.FRONT_BOTTOM_LEFT)
