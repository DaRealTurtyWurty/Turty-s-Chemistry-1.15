...
public class GasExtractorTileEntity extends TileEntity
    ...
    public void tick() {
        if (!this.world.isRemote && this.gasStored < 3000
            ...
            this.gasStored += 1000;
            markDirty();
            this.world.markAndNotifyBlock(this.pos, this.world.getChunkAt(this.pos), getBlockState(),
                    getBlockState(), Constants.BlockFlags.BLOCK_UPDATE, 0);
        }
    }
