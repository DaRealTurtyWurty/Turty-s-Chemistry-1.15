...
public class BriquettingPressBlock extends BaseHorizontalBlock {
    ...
    private static final Optional<VoxelShape> SHAPE = Stream
            .of(Block.makeCuboidShape(0, 0, 2, 1, 1, 3), Block.makeCuboidShape(0, 0, 13, 1, 1, 14),
                    ...
                    Block.makeCuboidShape(2, 12, 4.8, 2.5, 12.75, 5),
                    Block.makeCuboidShape(3, 12, 4.8, 3.5, 12.75, 5),
                    ...
                    Block.makeCuboidShape(5, 12, 4.8, 5.5, 12.3, 5),
                    Block.makeCuboidShape(5, 12.6, 4.8, 5.5, 12.9, 5),
    ...
    public BriquettingPressBlock(final Properties builder) {
        super(builder);
        if (SHAPE.isPresent()) {
