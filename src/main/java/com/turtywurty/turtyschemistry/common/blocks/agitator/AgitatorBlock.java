...
public class AgitatorBlock extends BaseHorizontalBlock {
	...
	private static final Optional<VoxelShape> SHAPE = Stream
			.of(Block.makeCuboidShape(7.5, 10, 8.5, 8.5, 11, 13), Block.makeCuboidShape(4, 0, 0, 12, 1, 1),
	...
	public ActionResultType onBlockActivated(final BlockState state, final World worldIn, final BlockPos pos,
		...
		if (worldIn.getTileEntity(pos) instanceof AgitatorTileEntity && !worldIn.isRemote) {
			...
			IContainerProvider provider = AgitatorContainer.getServerContainerProvider(tile, pos, tile.getAgitatorType());
