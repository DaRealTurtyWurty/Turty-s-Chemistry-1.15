...
public class BunsenBurnerBlock extends Block {
	...
	public void animateTick(BlockState stateIn, World worldIn, BlockPos pos, Random rand) {
		if (!stateIn.get(HAS_GAS)) {
			...
			case 1:
				// yellow
				addFireParticles(worldIn, pos, 20,
						new Color(Color.ORANGE.getRed(), Color.ORANGE.getGreen(), Color.ORANGE.getBlue(), 250), 0.075D);
				break;
			case 2:
				// yellow
			...
			case 3:
				...
				addFireParticles(worldIn, pos, 10,
						new Color(Color.YELLOW.getRed(), Color.YELLOW.getGreen(), Color.YELLOW.getBlue(), 30), 0.003D);
				break;
			case 4:
				// yellow
			...
			case 8:
				// blue
				addFireParticles(worldIn, pos, 12,
						new Color(Color.BLUE.getRed(), Color.BLUE.getGreen(), Color.BLUE.getBlue() - 80, 100), 0.02D);
				break;
			default:
				// none
