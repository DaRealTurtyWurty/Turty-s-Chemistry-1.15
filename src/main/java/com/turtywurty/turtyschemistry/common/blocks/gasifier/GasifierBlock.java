...
public class GasifierBlock extends Block {
    ...
    public enum GasifierPart implements IStringSerializable {
        FUEL_FEEDER_BOTTOM("fuel_feeder_bottom"), FUEL_FEEDER_TOP("fuel_feeder_top"),
        GAS_COOLER("gas_cooler"), GAS_FILTER_SCRUBBER("gas_filter_scrubber"),
        GAS_TANK_BOTTOM("gas_tank_bottom"), GAS_TANK_MIDDLE("gas_tank_middle"), GAS_TANK_TOP("gas_tank_top"),
        GASIFIER_BOTTOM("gasifier_bottom"), GASIFIER_MIDDLE("gasifier_middle"), GASIFIER_TOP("gasifier_top"),
        TAR_REFORMER_BOTTOM("tar_reformer_bottom"), TAR_REFORMER_MIDDLE("tar_reformer_middle"),
        TAR_REFORMER_TOP("tar_reformer_top");
