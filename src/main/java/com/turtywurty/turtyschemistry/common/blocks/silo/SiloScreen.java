...
public class SiloScreen extends ContainerScreen<SiloContainer> {
    ...
    public SiloScreen(final SiloContainer screenContainer, final PlayerInventory inv,
    ...
    protected void init() {
        ...
        this.addButton(
                new NextPageButton(
                        this.guiLeft + 229, this.guiTop + 164, 16, 11, button -> TurtyChemistry.PACKET_HANDLER
                                .send(PacketDistributor.SERVER.noArg(), new SiloButtonPacket(1)),
                        this.container));

        this.addButton(
                new BackPageButton(
                        this.guiLeft + 13, this.guiTop + 164, 16, 11, button -> TurtyChemistry.PACKET_HANDLER
                                .send(PacketDistributor.SERVER.noArg(), new SiloButtonPacket(0)),
                        this.container));
    }
    ...
    public static class BackPageButton extends Button {
        ...
        public void renderWidget(final MatrixStack stack, final int mouseX, final int mouseY,
            ...
            if (!isMouseOver(mouseX, mouseY)) {
                ClientUtils.renderButton(stack, BUTTON_TEXTURES, this, partialTicks, this.alpha, 0, 0,
                        this.width, this.height, 64, 64);
            } else {
                ClientUtils.renderButton(stack, BUTTON_TEXTURES, this, partialTicks, this.alpha, 0, 11,
                        this.width, this.height, 64, 64);
            }
        }
    }
    ...
    public static class NextPageButton extends Button {
        ...
        public void renderWidget(final MatrixStack stack, final int mouseX, final int mouseY,
            ...
            if (!isMouseOver(mouseX, mouseY)) {
                ClientUtils.renderButton(stack, BUTTON_TEXTURES, this, partialTicks, this.alpha, 16, 0,
                        this.width, this.height, 64, 64);
            } else {
                ClientUtils.renderButton(stack, BUTTON_TEXTURES, this, partialTicks, this.alpha, 16, 11,
                        this.width, this.height, 64, 64);
            }
        }
    }
