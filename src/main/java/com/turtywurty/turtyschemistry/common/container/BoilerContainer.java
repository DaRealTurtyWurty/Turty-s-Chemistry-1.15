...
import com.turtywurty.turtyschemistry.core.util.syncdata.BoilerSyncData;
...
public class BoilerContainer extends Container {
	...
	public BoilerContainer(int id, final PlayerInventory playerInventory, IItemHandler slots, BlockPos pos,
			IIntArray data) {
